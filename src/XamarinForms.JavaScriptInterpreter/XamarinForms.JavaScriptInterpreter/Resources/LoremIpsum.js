// Credit: https://github.com/f/loremjs/blob/master/lorem.js
...
(function () {
    ...
    Lorem.prototype.createLorem = function (kind, count) {
...
var callback = function (input) {
    ...
    var lorem = new Lorem;
    var result = lorem.createLorem('Sentence', parseInt(length));

    context.Alert("Lorem Ipsum", result);
}

context.Prompt("Lorem Ipsum Generator", "How many sentences would you like to create?", "10", callback);